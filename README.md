...
![Version](https://img.shields.io/badge/version-1.3.12-5b5bd6.svg)
...
- 🛟 **招呼语模式可选**：可切换「AI 生成 JD 专属招呼语」或「固定招呼语」，固定招呼语支持在设置页直接编辑，并可自动在开头追加称呼（如“高姐，您好！”）；AI 模式生成为空时自动用固定招呼语兜底
...
- ⚠️ **安全验证检测**：页面触发人机验证/安全验证时自动停止投递并提示，避免空转浪费
