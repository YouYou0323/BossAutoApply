...
(function () {
  ...
  function parseCard(card) {
    ...
    const actM = (card.textContent || '').match(/(刚刚活跃|刚刚在线|今日活跃|今日在线|昨天活跃|\d+天前活跃|\d+天内活跃|\d+日内活跃|\d+周内活跃|一周内活跃|7日内活跃|近7日活跃|近7天活跃|本周活跃|本月活跃|近30日活跃|一个月内活跃|半年内活跃|近半年活跃|一年内活跃|近一年活跃|半年前活跃|一年前活跃|活跃于半年前|数月前活跃|很久前活跃|\d+个月前活跃|几乎不活跃)/);
    ...
    try {
      ...
      const applyApi = (it, job) => {
        ...
        if (!job.activity) {
          for (const k in it) {
            const v = it[k];
            if (typeof v === 'string' && /(刚刚活跃|刚刚在线|今日活跃|今日在线|昨天活跃|\d+天前活跃|\d+天内活跃|\d+日内活跃|\d+周内活跃|一周内活跃|7日内活跃|近7日活跃|近7天活跃|本周活跃|本月活跃|近30日活跃|一个月内活跃|半年内活跃|近半年活跃|一年内活跃|近一年活跃|半年前活跃|一年前活跃|活跃于半年前|数月前活跃|很久前活跃|\d+个月前活跃|几乎不活跃)/.test(v)) {
              job.activity = v;
              break;
            }
          }
